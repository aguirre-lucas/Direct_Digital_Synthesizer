...
HD_PWD='C:/Users/lucas/VivadoProjects/direct_digital_synthesizer/direct_digital_synthesizer.runs/i2s_transmitter_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_transmitter_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2s_transmitter_0.tcl
